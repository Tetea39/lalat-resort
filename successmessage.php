...
<body class="fontbody" style="background-image : url(img/background.jpg) no-repeat center center fixed; background-size: cover;">
	<div class="row ">
		<div class="large-4 columns blackblur " style="margin-top:100px; ">
			<p class="fontslabo " style="text-align:left; font-size:18px;"><br>
			<h4>Payment Deposit Accepted</h4>
			<hr><br>Please check your email regarding your deposit payment through PayPal. Thank you on using our facility.</p>
			<br>
			<a class="button small" style="background-color:#2ecc71;" href="index.php">Homepage</a>
