...
<script>
	...
	function downloadResult(tableId, filename) {
		var csv = [];
...
<body>
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<div class="container-fluid">
					...
					<div class="row">
						...
						<div class="col-xs-6" id="statistics" style="display:block; padding-top: 10px">
								...
								<table class="table table-striped" id='table'>
									<thead>
										<tr>
											...
											<th>
												<button onclick="downloadResult('table', 'bookingResult.csv')">
													Download Result
												</button>
											</th>
										</tr>
								...
								<table class="table table-striped" id="table-1">
									<thead>
										<tr>
											...
											<th>Payment Status</th>
											<th>
												<button onclick="downloadResult('table-1', 'bookingResult.csv')">
													Download Result
												</button>
											</th>
										</tr>
								...
								<table class="table table-striped" id="table-2">
									<thead>
										<tr>
											...
											<th>Payment Status</th>
											<th>
												<button onclick="downloadResult('table-2', 'bookingResult.csv')">
													Download Result
												</button>
											</th>
										</tr>
								...
								<table class="table table-striped" id="table-3">
									<thead>
										<tr>
											...
											<th>Payment Status</th>
											<th>
												<button onclick="downloadResult('table-3', 'bookingResult.csv')">
													Download Result
												</button>
											</th>
										</tr>
	...
	<!-- this need to be uncomment again for the graph -->
